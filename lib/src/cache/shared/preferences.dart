...
class _LocalManager {
  ...
  /// The `static _LocalManager get instance` method is a getter method
  /// that returns an instance of the
  /// `_LocalManager` class. It follows the singleton design pattern,
  ...
  /// The `Future<SharedPreferences> get preferences async` method is a getter
  ///  method that returns a
  /// `Future` object representing the preferences stored in the local storage.
  /// It is marked as `async`
  /// because it performs an asynchronous operation,
  /// which is retrieving the `SharedPreferences`
  ...
  /// The `writeModelInJson` method is responsible for writing
  ///  a model object in JSON
  ...
  /// The function `getModelString` is a Dart asynchronous function
  ...
  ///
  /// Args:
  ///   url (String): The URL is a string that represents the location
  /// or address of a resource on the
  /// internet. In this case, it is used as a parameter
  ///  for the `removeAllLocalData` function.
  ...
  ///
  /// Args:
  ///   url (String): The `url` parameter is a string that represents
  ///  the URL of the model that you want
  /// to remove.
